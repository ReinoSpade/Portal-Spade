...
async function loadHome(){
  try{
    ...
    try{ active=await api("/api/active-activities"); }catch(_){ /* a falha no feed ao vivo não impede a Home de carregar */ }
    state.data=d;state.activeActivities=active.activities||[];renderHomeAnnouncements(d.announcements||[]);renderHomeActiveActivities(state.activeActivities);
